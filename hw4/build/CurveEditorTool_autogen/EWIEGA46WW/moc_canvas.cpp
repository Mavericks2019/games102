...
QT_MOC_LITERAL(1, 7, 12), // "pointHovered"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5), // "point"
QT_MOC_LITERAL(4, 27, 14) // "noPointHovered"

    },
    "Canvas\0pointHovered\0\0point\0noPointHovered"
};
...
void Canvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Canvas::*)(const QPointF & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Canvas::pointHovered)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Canvas::noPointHovered)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Canvas::pointHovered(const QPointF & _t1)
{
